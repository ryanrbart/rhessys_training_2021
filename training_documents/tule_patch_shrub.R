...
input_rhessys = IOin_rhessys_input(
  ...
  tec_file = "ws_tule/tecfiles/patch_shrub.tec",
  world_file = "ws_tule/worldfiles/patch_shrub.world",
  world_hdr_prefix = "patch_shrub",
  flowtable = "ws_tule/flowtables/patch_shrub.flow",
  start = "2000 10 1 1",
  end = "2100 09 30 1",
  output_folder = "ws_tule/out",
  output_prefix = "patch_shrub",
